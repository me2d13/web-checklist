...
function isInteractiveModeEnabled() {
    const radio = document.getElementById('mode-interactive');
...
function renderElementsWithPageBreaks(elements, container, namedStyles, defaultStyle, columns, titles, titleStyle) {
    ...
    pages.forEach((pageElements, index) => {
        ...
        footer.innerHTML = 'Generated by web checklist - <a href="https://github.com/me2d13/web-checklist" target="_blank" rel="noopener noreferrer">https://github.com/me2d13/web-checklist</a>';
